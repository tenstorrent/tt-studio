...
# Consolidated config store (issue #807): one namespaced JSON at the repo root,
# bind-mounted into the backend container. The three paths below are legacy
# sources, read only by the one-time migration and removed by --purge-all.
