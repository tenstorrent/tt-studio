...
def _entry(
    ...
    report_bug: bool = typer.Option(False, "--report-bug", help="Collect a diagnostics bundle and file a Jira ticket (or open a pre-filled GitHub issue without Jira credentials).", rich_help_panel="Troubleshooting & Info"),
