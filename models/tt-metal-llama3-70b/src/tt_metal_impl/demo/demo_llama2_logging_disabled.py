...
def latency_printout(latencies, args, generated_len):
    ...
    print(f"Tokens per second per user: {tokens_per_second_per_user:.1f} tokens/s/u")
    print(
...
@pytest.mark.parametrize(
    ...
    [
        (
            128,
            "/home/user/tt-metal-llama2-70b/src/tt_metal_impl/demo/data/multi_prompt.json",
            True,
            1,
            1,
            1.0,
