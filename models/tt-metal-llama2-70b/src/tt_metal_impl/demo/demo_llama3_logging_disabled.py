...
def main(args):
    ...
    with torch.no_grad():
        ...
        if args.output_at_end:
            with open(
                "models/demos/t3000/llama3_70b/demo/data/demo_user_output.txt", "w"
            ) as f:
...
@pytest.mark.parametrize(
    ...
    [
        (
            128,
            "models/demos/t3000/llama3_70b/demo/data/multi_prompt.json",
            True,
            1,
            1,
            1.0,
...
def test_LlamaModel_demo(
    ...
    devices, ckpt_dir, tokenizer_path, cache_path = get_llama_path(
        devices, model_config_default, n_devices, False
    )
