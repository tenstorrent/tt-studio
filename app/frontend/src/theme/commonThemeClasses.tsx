...
export function useTableCommonClasses(): TableCommonClasses {
  ...
  return useMemo(() => {
    ...
    const borderColor = theme === "dark" ? "border-zinc-400" : "border-gray-500";
    const tableCaptionColor = theme === "dark" ? "text-zinc-400" : "text-gray-500";
    const tableRowBgColor = theme === "dark" ? "bg-zinc-900" : "bg-zinc-200";
    const tableRowFadeBgColor = theme === "dark" ? "bg-zinc-700" : "bg-zinc-200";
