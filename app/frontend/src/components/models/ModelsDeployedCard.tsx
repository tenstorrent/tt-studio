...
export default function ModelsDeployedCard(): JSX.Element {
  ...
  return (
    ...
    <ElevatedCard accent="neutral" depth="lg" hover>
      ...
      {/* Chip slot visualization for multi-chip boards (hidden on QB2/P300x2) */}
      {isMultiChipBoard && chipStatus && chipStatus.board_type !== "P300x2" && (
          ...
          <ScrollArea className="whitespace-nowrap rounded-md">
            <Table>
              <ModelsTable
                ...
                hideDeviceId={chipStatus?.board_type === "P300x2"}
                healthMap={healthMap}
