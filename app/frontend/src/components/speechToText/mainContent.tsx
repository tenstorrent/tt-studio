...
export function MainContent({
  ...
  const scrollToBottom = (behavior: ScrollBehavior = "smooth") => {
    if (conversationEndRef.current && contentContainerRef.current) {
      ...
      const endElementPosition = conversationEndRef.current.offsetTop;
      const scrollPosition = endElementPosition - containerHeight + 200; // Add some padding

      scrollToPosition(scrollPosition, behavior);
    }
  };
      ...
      <div className="max-w-4xl mx-auto w-full flex-1">
        ...
        {!selectedConversation || showRecordingInterface ? (
          ...
          <div className="space-y-6 flex-1 flex flex-col min-h-0">
            <Card className="p-6 bg-background/50 backdrop-blur-sm border-TT-blue-shade dark:bg-[#2A2A2A]/50 dark:border-TT-purple/20">
            ...
            <div className="flex-1 overflow-visible">
              {groupTranscriptionsByDate(
                ...
                <div key={group.date} className="space-y-4 mb-4">
            ...
            <div
              className="flex justify-center items-center py-8 mt-4 border-2 border-dashed border-TT-purple-shade rounded-lg bg-white dark:bg-[#2A2A2A] hover:bg-TT-purple-shade/10 dark:hover:bg-TT-purple/10 transition-colors"
