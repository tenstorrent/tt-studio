...
import VideoI2VInputArea from "./VideoI2VInputArea";
import type { VideoGenChatProps } from "./types/chat";
import { useVideoI2VChat } from "./hooks/useVideoI2VChat";

const VideoGenI2VChat: React.FC<VideoGenChatProps> = ({
  onBack,
  modelID,
  initialPrompt = "",
}) => {
                  ...
                  >
                    {message.imagePreview && (
                      <img
                        ...
                        className="mb-2 rounded-lg max-h-40 max-w-[16rem] object-cover"
                      />
                    )}
                    <p
                      className={
      ...
      <div className="p-6">
        <div className="max-w-5xl mx-auto">
          <VideoI2VInputArea
            ...
            handleGenerate={(input, image) => sendMessage(input, image)}
...
export default VideoGenI2VChat;
