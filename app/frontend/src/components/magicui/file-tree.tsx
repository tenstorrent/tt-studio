...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "h-full w-px bg-stone-100 absolute left-1.5 rtl:right-1.5 py-3 rounded-md hover:bg-slate-300 duration-300 ease-in-out dark:bg-stone-800",
        className,
      )}
      {...props}
    />
      ...
      >
        <AccordionPrimitive.Trigger
          className={cn(
            ...
            className,
            {
              "bg-stone-100 rounded-md dark:bg-stone-800":
...
>(
  (
    ...
    const handleClick = () => {
      if (isSelectable) {
        selectItem(value); // Track the selected file
        if (handleSelect) handleSelect(value); // Trigger external handler if provided
      }
    };
      ...
      <AccordionPrimitive.Item value={value} className="relative">
        <AccordionPrimitive.Trigger
          ...
          className={cn(
            ...
            {
              "bg-stone-100 dark:bg-stone-800": isSelected && isSelectable,
            },
