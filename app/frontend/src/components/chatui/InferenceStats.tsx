  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-[500px] p-6 bg-black text-white border-zinc-800">
          ...
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2 text-xl font-medium text-white ">
              <Zap className="h-10 w-10 text-TT-purple-accent" />
              Inference Speed Insights
            </DialogTitle>
          </DialogHeader>

          <div className="space-y-8 py-6 border-t border-zinc-800">
          ...
          {/* !TODO  */}
          {/* add model name here  */}
          {/* <div className="border-t border-zinc-800 pt-4 text-sm text-white/60 flex items-center gap-2"> */}
          {/* <span>
              Round trip time:{" "}
              {formatValue(
                (stats.user_ttft_s || 0) +
            ...
            <span>Model: {stats.model || "Unknown"}</span> */}
          {/* </div> */}
        </DialogContent>
      </Dialog>
    </>
