...
import { EndpointsTab, ExamplesTab } from "./tabs";
      ...
      <CardContent className="p-4">
        <div className="space-y-6">
          <Tabs defaultValue="endpoints" className="space-y-4">
            <TabsList className="grid w-full grid-cols-2 bg-gray-100 dark:bg-zinc-800 border border-gray-200 dark:border-gray-700 rounded-lg p-1">
              <TabsTrigger
                value="endpoints"
