...
TOOL_CALLING_PROMPT = ChatPromptTemplate.from_messages([
    ("system",
     "You are a helpful Search Agent with access to web search. Your job is to "
     "provide answers grounded in real, up-to-date information.\n\n"
     "RULES:\n"
     "1. Use the web search tool for current events, weather, travel, news, "
     ...
     "3. Use at most TWO tool calls per question, then answer.\n"
